...
@implementation VuforiaEAGLView {
    ...
    //Renderer
    SCNRenderer* _rendererLeft;
    SCNRenderer* _rendererMiddle;
    SCNRenderer* _rendererRight;
    SCNRenderer* _rendererFull;
    
    //Camera Node
    SCNNode* _cameraNodeLeft;
    SCNNode* _cameraNodeMiddle;
    SCNNode* _cameraNodeRight;
    SCNNode* _cameraNodeFull;
    
    //Scene
    SCNScene* sceneLeft ;
    SCNScene* sceneMiddle;
    SCNScene* sceneRight;
    SCNScene* sceneFull;
...
- (void)setupRenderer {
    ...
    _rendererLeft = [SCNRenderer rendererWithContext:_context options:nil];
    _rendererLeft.autoenablesDefaultLighting = YES;
    _rendererLeft.playing = YES;
    
    _rendererMiddle = [SCNRenderer rendererWithContext:_context options:nil];
    _rendererMiddle.autoenablesDefaultLighting = YES;
    _rendererMiddle.playing = YES;
    
    _rendererRight = [SCNRenderer rendererWithContext:_context options:nil];
    _rendererRight.autoenablesDefaultLighting = YES;
    _rendererRight.playing = YES;
    
    _rendererFull = [SCNRenderer rendererWithContext:_context options:nil];
    _rendererFull.autoenablesDefaultLighting = YES;
    _rendererFull.playing = YES;
...
-(void)setNeedsChangeSceneForMiddle{
    ...
    sceneMiddle = [SCNScene sceneNamed:@"art.scnassets/middle.dae"];
    _cameraNodeMiddle = [SCNNode node];
    SCNCamera* camera = [SCNCamera camera];
    _cameraNodeMiddle.camera = camera;
    [sceneMiddle.rootNode addChildNode:_cameraNodeMiddle];
    _rendererMiddle.scene = sceneMiddle;
    _cameraNodeMiddle.camera.projectionTransform = _projectionTransform;
    
    _rendererMiddle.pointOfView = _cameraNodeMiddle;
}

-(void)setNeedsChangeSceneForLeft{
    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
    NSString  *documentsDirectory = [paths objectAtIndex:0];
     NSString *zipPath = [documentsDirectory stringByAppendingPathComponent:@"left.scn"];
    
    NSLog(@"zipPath:%@",zipPath);
    NSURL *floorPathURL = [NSURL fileURLWithPath:zipPath];
    
   sceneLeft = [SCNScene sceneWithURL:floorPathURL options:nil error:nil];
    
   // sceneLeft = [SCNScene sceneNamed:@"art.scnassets/left.scn"];
    _cameraNodeLeft=[SCNNode node];
    SCNCamera* camera = [SCNCamera camera];
    _cameraNodeLeft.camera = camera;
    [sceneLeft.rootNode addChildNode:_cameraNodeLeft];
    _rendererLeft.scene = sceneLeft;
    _cameraNodeLeft.camera.projectionTransform = _projectionTransform;
    
    _rendererLeft.pointOfView = _cameraNodeLeft;
    
}

-(void)setRenderNil{
    
    _rendererLeft.scene = nil;
}
...
-(void)setNeedsChangeSceneForRight{
    ...
    NSArray *paths = NSSearchPathForDirectoriesInDomains(NSDocumentDirectory, NSUserDomainMask, YES);
    NSString  *documentsDirectory = [paths objectAtIndex:0];
    NSString *zipPath = [documentsDirectory stringByAppendingPathComponent:@"right.scn"];
    
    NSLog(@"zipPath:%@",zipPath);
    NSURL *floorPathURL = [NSURL fileURLWithPath:zipPath];
    
    sceneRight = [SCNScene sceneWithURL:floorPathURL options:nil error:nil];
    //sceneRight = [SCNScene sceneNamed:@"art.scnassets/right.dae"];
    _cameraNodeRight=[SCNNode node];
    SCNCamera* camera = [SCNCamera camera];
    _cameraNodeRight.camera = camera;
    [sceneRight.rootNode addChildNode:_cameraNodeRight];
    _rendererRight.scene = sceneRight;
    _cameraNodeRight.camera.projectionTransform = _projectionTransform;
    
    _rendererRight.pointOfView = _cameraNodeRight;
    
}

-(void)setNeedsChangeSceneForFull{
    
    _cameraNodeFull.camera.projectionTransform = _projectionTransform;
    [sceneFull.rootNode addChildNode:_cameraNodeFull];
    _rendererFull.pointOfView = _cameraNodeFull;
...
- (void)setCameraMatrix:(Vuforia::Matrix44F)matrix with:(NSString *)string{
    
    SCNMatrix4 extrinsic = [self SCNMatrix4FromVuforiaMatrix44:matrix];
    SCNMatrix4 inverted = SCNMatrix4Invert(extrinsic);
    
    
    if ([string isEqualToString:@"radio_panel_left_6"] || [string isEqualToString:@"radio_panel_left_5"] || [string isEqualToString:@"radio_panel_left_4"] || [string isEqualToString:@"radio_panel_left_3"] || [string isEqualToString:@"radio_panel_left_2"] || [string isEqualToString:@"radio_panel_left_1"]) {
        
        _cameraNodeLeft.transform = inverted;
      
    }
    
    if ([string isEqualToString:@"radio_panel_middle_18"] ||[string isEqualToString:@"radio_panel_middle_17"] || [string isEqualToString:@"radio_panel_middle_19"]  || [string isEqualToString:@"radio_panel_middle_14"] ) {
        
//        ([string isEqualToString:@"radio_panel_middle_12"] ||[string isEqualToString:@"radio_panel_middle_12"] || [string isEqualToString:@"radio_panel_middle_11"] || [string isEqualToString:@"radio_panel_middle_10"] || [string isEqualToString:@"radio_panel_middle_9"] || [string isEqualToString:@"radio_panel_middle_8"] || [string isEqualToString:@"radio_panel_middle_7"]||[string isEqualToString:@"radio_panel_middle_6"] || [string isEqualToString:@"radio_panel_middle_5"] || [string isEqualToString:@"radio_panel_middle_4"] || [string isEqualToString:@"radio_panel_middle_3"] || [string isEqualToString:@"radio_panel_middle_2"] || [string isEqualToString:@"radio_panel_middle_1"])
//
        _cameraNodeMiddle.transform = inverted;
       
    }
    
    if ([string isEqualToString:@"radio_panel_right_6"] || [string isEqualToString:@"radio_panel_right_5"] || [string isEqualToString:@"radio_panel_right_4"] || [string isEqualToString:@"radio_panel_right_3"] || [string isEqualToString:@"radio_panel_right_2"] || [string isEqualToString:@"radio_panel_right_1"]) {
        
        _cameraNodeRight.transform = inverted;
        
    }
    
    if ([string isEqualToString:@"radio_panel_full_5"] || [string isEqualToString:@"radio_panel_full_4"] || [string isEqualToString:@"radio_panel_full_3"] || [string isEqualToString:@"radio_panel_full_2"] || [string isEqualToString:@"radio_panel_full_1"]) {
        
        _cameraNodeFull.transform = inverted;
...
- (void)renderFrameVuforia
{
    ...
    for (int i = 0; i < state.getNumTrackableResults(); ++i) {
        ...
        NSString  *string = [NSString stringWithUTF8String:trackable.getName()];
        [self setCameraMatrix:modelViewMatrix with:string];
        CFAbsoluteTime currentTime = CFAbsoluteTimeGetCurrent() - _startTime;
        // render using SCNRenderer
        
        if ([string isEqualToString:@"radio_panel_middle_18"] ||[string isEqualToString:@"radio_panel_middle_17"] || [string isEqualToString:@"radio_panel_middle_16"] || [string isEqualToString:@"radio_panel_middle_15"] || [string isEqualToString:@"radio_panel_middle_14"] ) {
            
            
//            ([string isEqualToString:@"radio_panel_middle_12"] ||[string isEqualToString:@"radio_panel_middle_12"] || [string isEqualToString:@"radio_panel_middle_11"] || [string isEqualToString:@"radio_panel_middle_10"] || [string isEqualToString:@"radio_panel_middle_9"] || [string isEqualToString:@"radio_panel_middle_8"] || [string isEqualToString:@"radio_panel_middle_7"]||[string isEqualToString:@"radio_panel_middle_6"] || [string isEqualToString:@"radio_panel_middle_5"] || [string isEqualToString:@"radio_panel_middle_4"] || [string isEqualToString:@"radio_panel_middle_3"] || [string isEqualToString:@"radio_panel_middle_2"] || [string isEqualToString:@"radio_panel_middle_1"])
            
            [_rendererMiddle renderAtTime: currentTime];
        }
        
        if (([string isEqualToString:@"radio_panel_left_6"] || [string isEqualToString:@"radio_panel_left_5"] || [string isEqualToString:@"radio_panel_left_4"] || [string isEqualToString:@"radio_panel_left_3"] || [string isEqualToString:@"radio_panel_left_2"] || [string isEqualToString:@"radio_panel_left_1"])) {
            
            [_rendererLeft renderAtTime: currentTime];
        }
        
        if ([string isEqualToString:@"radio_panel_right_6"] || [string isEqualToString:@"radio_panel_right_5"] || [string isEqualToString:@"radio_panel_right_4"] || [string isEqualToString:@"radio_panel_right_3"] || [string isEqualToString:@"radio_panel_right_2"] || [string isEqualToString:@"radio_panel_right_1"]) {
            
            [_rendererRight renderAtTime: currentTime];
        }
        
        if ([string isEqualToString:@"radio_botttom_03"]) {
            [_rendererFull renderAtTime: currentTime];
        }
...
- (SCNNode*)touchedNodeWithLocationInView:(CGPoint)location {
    ...
    NSArray* results = [_rendererMiddle hitTest:pos options:nil];
    NSArray* resultsScond = [_rendererLeft hitTest:pos options:nil];
    NSArray* resultsBlue = [_rendererRight hitTest:pos options:nil];
    NSArray* resultsRed = [_rendererFull hitTest:pos options:nil];
    
    if (results.count != 0) {
        return [[results firstObject] node];
    } else if (resultsScond.count != 0){
        return [[resultsScond firstObject] node];
    }else if (resultsBlue.count != 0){
        return [[resultsBlue firstObject] node];
    }else{
        return [[resultsRed firstObject] node];
    }
